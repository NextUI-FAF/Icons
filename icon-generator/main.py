...
def create_faf_custom_icons() -> None:
    ...
    compose_faf_icon_with_variants([square, antiair_symbol_outlined], "icon_structure[T]_antiair", [1, 2, 3])
    compose_faf_icon_with_variants([square, directfire_symbol_outlined], "icon_structure[T]_directfire", [1, 2, 3])
